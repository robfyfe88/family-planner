      ...
      <div className="p-6">
        <div className="max-w-md mx-auto text-center p-8 border rounded-2xl bg-[var(--card-bg)]">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-[var(--accent-2)] text-white shadow-sm hover:opacity-90 active:translate-y-px focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent-2)]"
          >
            <GoogleIcon />
      ...
      <header className="flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg border border-[var(--border-color)] bg-white hover:bg-gray-50 active:translate-y-px focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-300"
            title="Sign out"
          >
            <LogoutIcon />
...
function LogoutIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" aria-hidden>
      <path
        d="M16 17l5-5-5-5v3H9v4h7v3z"
        fill="currentColor"
      />
      <path
        d="M4 4h8v2H6v12h6v2H4a2 2 0 01-2-2V6a2 2 0 012-2z"
        fill="currentColor"
        opacity=".6"
      />
    </svg>
