...
import { User, Users, Bell, CreditCard, Cog, LogOut } from "lucide-react";
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button
          type="button"
          className="inline-flex items-center gap-2 px-2.5 py-1.5 rounded-full border border-[var(--border-color)] bg-white max-w-[60vw] sm:max-w-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent-2)]"
