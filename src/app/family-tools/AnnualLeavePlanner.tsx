...
// Simple override code map for persistence & UI
type OverrideCode =
    | "A"
    | "B"
    | "both"
...
function planAnnualLeave(input: PlanInput) {
    ...
    // Joint days (only if there are 2 parents)
